...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $Link = $gestionLinks->RechercherParId($id);
}
...
if(isset($_POST['modifier'])){
    ...
    $Price = $_POST['Price'];
        ...
        $gestionLinks->Modifier($affiliate_id, $affiliate_Name, $Link, $Price);
  ...
  <!-- /.navbar -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="affiliatelinks.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all Affiliate</p>
                </a>
              </li>
            ...
            <div class="card card-warning">
                ...
                <div class="card-body">
                    <form method="post" action="">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="hidden" class="form-control" name="affiliate_id"
                                    value="<?=$Link->getAffiliate_Id() ?>" placeholder="Product Name">

                                <label>affiliate Name</label>
                                <input type="text" class="form-control" name="affiliate_Name"
                                    value="<?=$Link->getAffiliate_Name() ?>" placeholder="Product Name">
                            </div>
                            <div class="col-sm-3">
                                <label>Price</label>
                                <input type="number" class="form-control" name="Price" value="<?=$Link->getPrice() ?>" placeholder="Price">
                            </div>
                            <div class="col-sm-6">
                                <label>affiliate Link</label>
                                <input type="text" class="form-control" name="Link" value="<?=$Link->getAffiliate_Link() ?>" placeholder="Link">
                            </div>
                        </div>

<?php
include "../../Managers/GestionLinks.php";
...
if (!empty($_POST)) {
    $affiliate = new link();
    $affiliate->setAffiliate_Name($_POST['affiliate_Name']);
    $affiliate->setProduct_Id($_GET['id']);
    $affiliate->setAffiliate_Link($_POST['Link']);
    $affiliate->setPrice($_POST['Price']);
    $gestionLinks->AjouterAffiliateToProduct($affiliate);
                ...
                <div class="card-body">
                    <form method="post" action="">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-success w-75 mt-5">ADD link</button>
                        </div>

...
if (!empty($_POST['Type_Name'])) {
  ...
  if (isset($_GET['id'])) {
    ...
    $type = new type();
    $type->setType($_POST['Type_Name']);
    $type->setCategory($_GET['id']);  
    $gestionTypes->AjouterTypeToCategory($type);
                ...
                <div class="card-body">
                    <form method="post" action="">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-success w-75 mt-5">Add type to category</button>
                        </div>

...
$affiliates = $gestionLinks->RechercherTous();
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($affiliates as $affiliate) {
                                ...
                                <tr>
                                    <td>
                                        <?= $affiliate->getAffiliate_Name() ?>
                                    </td>
                                    <td style=" max-width: 40%;">
                                        <?= $affiliate->getAffiliate_Link() ?>
                                    </td>
                                    <td>
                                        <?= $affiliate->getPrice() ?>
                                    </td>
                                    <td>
                                        <?= $affiliate->getProduct_Id() ?>
                                    </td>
                                    <td>
                                        <a href="editer.php?id=<?php echo $affiliate->getAffiliate_Id() ?>"
                                            class="btn btn-warning">Éditer</a>
                                        <a href="suprimer.php?id=<?php echo $affiliate->getAffiliate_Id() ?>"

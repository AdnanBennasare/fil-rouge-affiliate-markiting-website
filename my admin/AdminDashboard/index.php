...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="Views/assets/vendor/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="Views/assets/vendor/dist/img/solicodelogo.jfif" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Views/Product/index.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all products</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Views/Product/ajouter.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>add products</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Views/Category/index.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all categorys</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Views/Category/ajouterCategory.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>add categorys</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Views/Type/Types.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all Types</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="Views/Type/ajouterType.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>add Type</p>
                </a>
              </li>
         ...
         <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Views/affiliateLink/affiliatelinks.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>all Affiliate</p>
                </a>
              </li>
      ...
      <div class="row">
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-info">
            <div class="inner">
              <?php 
              $products = "products";
              $numberOfProducts = $gestionProducts->GetProductCount($products);
              ?>
            ...
            <a href="Views/Product/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-success">
            ...
            <?php 
               $affilite = "affiliate";
              $numberAflinks =  $gestionProducts->GetProductCount($affilite);
              ?>
            <h3><?php echo $numberAflinks ?></h3>
            <h4>Affiliates links</h4>             
            </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
            <a href="Views/affiliateLink/affiliatelinks.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <?php 
            $user = "user";
              $numberofsubs = $gestionProducts->GetProductCount($user);
              ?>
              <h3><?php echo $numberofsubs ?></h3>
                <h4>Subscription</h4>             
              </div>
              <div class="icon">
                <i class="ion ion-person-add"></i>
              </div>
              <a href="Views/Users/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        <!-- ./col -->
        <div class="col-lg-3 col-6">
          ...
          <div class="small-box bg-danger">
            ...
            <?php 
               $category = "category";
              $numberCategories =  $gestionProducts->GetProductCount($category);
              ?>
            <h3><?php echo $numberCategories ?></h3>
            <h4>Categories</h4>   
            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
            <a href="Views/Category/index.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>

...
if (!empty($_POST['Category_Name'])) {
  ...
  $category->setCategoryImg($_POST['Gategory_Img']);
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="../assets/vendor/dist/img/user.png" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
          ...
          <form method="post" action="">
            ...
            <div class="row">
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control" name="Category_Name" placeholder="Enter a Category">
              </div>

              <div class="col-sm-9">
                <label>Category Img</label>
                <input type="text" class="form-control" name="Gategory_Img" placeholder="Enter a Category Img">
              </div>
            </div>

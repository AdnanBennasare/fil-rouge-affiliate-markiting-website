...
if (isset($_POST['modifier'])) {
  ...
  $Gategory_Img = $_POST['Gategory_Img'];


  $gestionCategorys->Modifier($id, $Product_Name, $Gategory_Img);
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="ajouterCategory.php" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>add categorys</p>
                  </a>
                </li>
    ...
    <div class="content-wrapper">
      ...
      <div class="card card-warning">
        <div class="card-header">
          <h3 class="card-title">Add a Category on the website</h3>
        </div>
        <div class="card-body">
          <form method="post" action="">
            ...
            <div class="row">
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control" value="<?= $Category->getCategory() ?>" name="Category_Name"
                  placeholder="Enter a Category">
                <input type="hidden" class="form-control" value="<?= $Category->getId() ?>" name="Category_id">
              ...
              <div class="col-sm-9">
                ...
                <input type="text" class="form-control" value="<?= $Category->getCategoryImg() ?>" name="Gategory_Img"
                  placeholder="Enter a Category Img">
              </div>
            ...
            <div class="d-flex justify-content-center">
              <button type="submit" name="modifier" class="btn btn-success w-75 mt-5">Modifie category</button>
            </div>
